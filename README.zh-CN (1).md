...
|-------------|-------------|---------------|
| ![Image Processing Architecture Project Architecture Diagram.drawio](AWS Project/Images Processing Project/Achitecture/Image Processing Architecture Project Architecture Diagram.drawio.png) | !![Security Incident Automation & Compliance Audit Platform Project Architecture Images.drawio](AWS Project/Security Incident Automation & Compliance Audit Platform Project/Achitecture/Security Incident Automation & Compliance Audit Platform Project Architecture Images.drawio.png) | ![Cost-Aware GenAI Document Assistant.drawio](AWS Project/Cost-Aware GenAI Document Assistant/Achitecture/Cost-Aware GenAI Document Assistant.drawio.png) |
